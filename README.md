...
<br><br>
<details>
<summary>Tech Stack & Projects</summary>
<div align="left">  

## Technologies & Tools

### LLM Models & AI Frameworks
<p align="center">
  <img src="https://img.shields.io/badge/Qwen3-FFB300?style=for-the-badge&logo=OpenAI&logoColor=white"/>
  <img src="https://img.shields.io/badge/Google%20Gemma3-4285F4?style=for-the-badge&logo=google&logoColor=white"/>
  <img src="https://img.shields.io/badge/GPT--4%20API-412991?style=for-the-badge&logo=openai&logoColor=white"/>
  <img src="https://img.shields.io/badge/BGE--M3-8C9EFF?style=for-the-badge&logo=HuggingFace&logoColor=white"/>
</p>
...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/Transformers-FFC000?style=for-the-badge&logo=HuggingFace&logoColor=black"/>
  <img src="https://img.shields.io/badge/LoRA-F76D57?style=for-the-badge&logo=HuggingFace&logoColor=white"/>
</p>
...
**[PASS - AI Patent Assistant](https://github.com/tpwls9494/SKN09-FINAL-3Team)**  
`Qwen3 Fine-tuning` `RAG` `Django` `FastAPI` `Docker` `AWS`  
AI service converting technical ideas into patent specifications  
*Team of 5 | 500M KRW saved | 672 hours → 2 minutes*

**[Travel Information Chatbot](https://github.com/tpwls9494/SKN09-4th-2Team)**  
`Google Gemma3` `Django` `Docker` `RunPod`  
Intelligent chatbot providing travel regulations and cultural information  
*Team of 4 | Full-stack architecture design*

**[LLM Room Escape Game](https://github.com/tpwls9494/LLM_Room_Escape)**  
`GPT-4 API` `Streamlit` `Python`  
Interactive escape room with dynamic theme generation

**[LLM Mafia Game](https://github.com/tpwls9494/LLM_mafia_3night)**  
`OpenAI API` `Streamlit` `AI Character System`  
Role-playing deduction game with AI-generated conversations

**[FoodPick - Recommendation System](https://github.com/tpwls9494/foodpick)**  
`Java` `Spring Boot` `MySQL` `JWT`  
Personalized food recommendation platform with RESTful API

**[Data Analysis Projects](https://github.com/tpwls9494/SKN_Family_project)**  
`Python` `Pandas` `TensorFlow` `Jupyter`  
6-month AI bootcamp portfolio with ML/DL projects
